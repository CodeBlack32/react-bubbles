...
Token are used for Authorization for applications when transfering info between client and server.

- [ ] What steps can you take in your web apps to keep your data secure?

A Good way would be to prioritize risk, run apps with priveleges, be sure to set up web security. Also make sure to set up thorough tests on your application.

- [ ] Describe how web servers work.

Web Servers are A central hub for storing, processing, and deilivering web pages to users. They take in HTTP requests and send requested info to the pages.
